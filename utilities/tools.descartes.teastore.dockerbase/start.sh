...
echo 'export JAVA_OPTS="-javaagent:/usr/local/tomcat/dd-java-agent.jar -Daj.weaving.verbose=false -Daj.weaving.loadersToSkip=java.net.URLClassLoader"' > /usr/local/tomcat/bin/setenv.sh
